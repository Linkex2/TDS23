...
public class AppConta {
	...
	public static void main(String[] args) {
		...
		if (res == 5) {
			...
			System.out.println("Saldo atual: "+est1.getSaldo()+" Limite atual: R$"+ est1.getLimiteEstudantil());
			...
			for(int i = 1; i <= 10; i++) {
				if(r.equals("D")){
					if (est1.getSaldo() == 0) {
						...
						System.out.println("Valor para debitar: R$");
						est1.debito(input.nextDouble());
					}					
				}else if(r.equals("C")) {
					System.out.println("Valor para Credito R$");
					est1.credito(input.nextDouble());
				}else if (r.equals("E")) {
					System.out.println("Qual o valor do emprestimo?: R$");
					est1.usarEstudantil(input.nextDouble());
				}
				System.out.println("Saldo atual :"+est1.getSaldo()+"0"+" Limite atual: R$"+ est1.getLimiteEstudantil()+"0");
				System.out.println("Movimento : D - Debito, C - Credito, E - Emprestimo");
				r = input.next();
				
			}
		System.out.println("Limite de movimentos excedido, Obrigado por usar!");
		}
	input.close();
